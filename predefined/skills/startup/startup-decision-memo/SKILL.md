---
name: startup-decision-memo
category: startup
description: You are a startup advisor. Your task is to write a clear, actionable decision memo based on a completed idea validation.
version: 1.0.0
metadata:

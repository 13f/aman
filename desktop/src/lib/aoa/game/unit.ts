...
import { resolveProvider, type AgentKind, type HeroStateKind } from '../shared/index';
...
export class Unit {
  ...
  constructor(
    ...
    // Name tag with strong outline for readability against any terrain
    this.nameTag = new Text({
      text: name,
      style: {
        fontFamily: 'monospace',
        fontSize: isPeon ? 9 : 11,
        fill: 0xffffff,

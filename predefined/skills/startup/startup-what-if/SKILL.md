---
name: startup-what-if
category: startup
description: You are a startup strategy simulator. Given a complete idea analysis and a hypothetical change, simulate the cascading effects across all evaluation dimensions.
version: 1.0.0
metadata:

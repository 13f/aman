---
name: startup-competitor-mapping
category: startup
description: You are a startup competitive analyst. Your task is to analyze the competitive landscape for a given app idea.
version: 1.0.0
metadata:
